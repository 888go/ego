...
var _bintree = &_bintree_t{nil, map[string]*_bintree_t{
	"call_js.html":            {call_js_html, map[string]*_bintree_t{}},
	"control.html":            {control_html, map[string]*_bintree_t{}},
	"css/test-css/test.css":   {css_test_css_test_css, map[string]*_bintree_t{}},
	"css/xspreadsheet.css":    {css_xspreadsheet_css, map[string]*_bintree_t{}},
	"drop_file.html":          {drop_file_html, map[string]*_bintree_t{}},
	"embed_loader.html":       {embed_loader_html, map[string]*_bintree_t{}},
	"events.html":             {events_html, map[string]*_bintree_t{}},
	"gobindata.html":          {gobindata_html, map[string]*_bintree_t{}},
	"hook.html":               {hook_html, map[string]*_bintree_t{}},
	"images/chrome.png":       {images_chrome_png, map[string]*_bintree_t{}},
	"images/close.png":        {images_close_png, map[string]*_bintree_t{}},
	"images/runjs.png":        {images_runjs_png, map[string]*_bintree_t{}},
	"images/web.png":          {images_web_png, map[string]*_bintree_t{}},
	"images/xspreadsheet.svg": {images_xspreadsheet_svg, map[string]*_bintree_t{}},
	"js/hook.js":              {js_hook_js, map[string]*_bintree_t{}},
	"js/xspreadsheet.js":      {js_xspreadsheet_js, map[string]*_bintree_t{}},
	"js_call.html":            {js_call_html, map[string]*_bintree_t{}},
	"runjs.html":              {runjs_html, map[string]*_bintree_t{}},
	"test.html":               {test_html, map[string]*_bintree_t{}},
	"transparent.html":        {transparent_html, map[string]*_bintree_t{}},
	"web.html":                {web_html, map[string]*_bintree_t{}},
	"window.html":             {window_html, map[string]*_bintree_t{}},
	"zipdemo.zip":             {zipdemo_zip, map[string]*_bintree_t{}},
}}
