...
type MiniblinkBrowser struct {
	...
	I事件_控制台输出 map[string]func(sender *MiniblinkBrowser, e ConsoleEvArgs)
	OnConsole func(e ConsoleEvArgs)

	I事件_文档就绪        map[string]func(sender *MiniblinkBrowser, e DocumentReadyEvArgs)
...
func (_this *MiniblinkBrowser) Init() *MiniblinkBrowser {
	...
	_this.I事件_控制台输出 = make(map[string]func(*MiniblinkBrowser, ConsoleEvArgs))
	_this.I事件_文档就绪 = make(map[string]func(*MiniblinkBrowser, DocumentReadyEvArgs))
...
func (_this *MiniblinkBrowser) I调用js函数(name string, param ...interface{}) interface{} {
