...
func toWinCursor(cursor fm.CursorType) int {
	...
	case fm.I鼠标样式_HELP:
		return win.IDC_HELP
	case fm.I鼠标样式_APPSTARTING:
		return win.IDC_APPSTARTING
	case fm.I鼠标样式_HAND:
		return win.IDC_HAND
	case fm.I鼠标样式_NO:
		return win.IDC_NO
	case fm.I鼠标样式_SIZEALL:
		return win.IDC_SIZEALL
	case fm.I鼠标样式_SIZENS:
		return win.IDC_SIZENS
	case fm.I鼠标样式_SIZEWE:
		return win.IDC_SIZEWE
	case fm.I鼠标样式_SIZENWSE:
		return win.IDC_SIZENWSE
	case fm.I鼠标样式_SIZENESW:
		return win.IDC_SIZENESW
	case fm.I鼠标样式_UPARROW:
...
func winCursorTo(cursor int) fm.CursorType {
	switch cursor {
	case win.IDC_ARROW:
		return fm.I鼠标样式_ARROW
	case win.IDC_IBEAM:
		return fm.I鼠标样式_IBEAM
	case win.IDC_WAIT:
		return fm.I鼠标样式_WAIT
	case win.IDC_CROSS:
		return fm.I鼠标样式_CROSS
	case win.IDC_UPARROW:
		return fm.I鼠标样式_UPARROW
	case win.IDC_SIZENWSE:
		return fm.I鼠标样式_SIZENWSE
	case win.IDC_SIZENESW:
		return fm.I鼠标样式_SIZENESW
	case win.IDC_SIZEWE:
		return fm.I鼠标样式_SIZEWE
	case win.IDC_SIZENS:
		return fm.I鼠标样式_SIZENS
	case win.IDC_SIZEALL:
		return fm.I鼠标样式_SIZEALL
	case win.IDC_NO:
		return fm.I鼠标样式_NO
	case win.IDC_HAND:
		return fm.I鼠标样式_HAND
	case win.IDC_APPSTARTING:
		return fm.I鼠标样式_APPSTARTING
	case win.IDC_HELP:
		return fm.I鼠标样式_HELP
	case win.IDC_ICON:
		return fm.I鼠标样式_ICON
	case win.IDC_SIZE:
		return fm.I鼠标样式_SIZE
	default:
		return fm.I鼠标样式_ARROW
	}
}
