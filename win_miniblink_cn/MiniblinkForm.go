...
import (
	...
	gw "e.coding.net/gogit/go/ego/core/win_miniblink_cn/forms/windows/win32"
	"fmt"
)
...
func (_this *MiniblinkForm) InitEx(param br.FormParam) *MiniblinkForm {
	...
	_this.View.I事件_文档就绪["__goMiniblink_init_js"] = func(_ *MiniblinkBrowser, e DocumentReadyEvArgs) {
...
func (_this *MiniblinkForm) setOn() {
	...
	_this.OnResize = func(e fm.Rect) {
		_this.View.I设置大小(e.Width, e.Height)
		bakOnResize(e)
	}
